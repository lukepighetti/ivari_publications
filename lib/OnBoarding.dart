...
final pages = [
  new PageViewModel(
      ...
      title: Text(
        'Notification',style: _fontHeaderStyle,
      ),
      body: Text(
        'Notification now coming to \nivari publication app soon.',textAlign: TextAlign.center,
  ...
  new PageViewModel(
      ...
      bubbleBackgroundColor: Colors.black,
      title: Text(
        'Say Hello to eForms',style: _fontHeaderStyle,
      ),
      body: Text(
          'Clients now have the option to complete and submit our two most popular paper forms online.',textAlign: TextAlign.center,
          style: _fontDescriptionStyle
      ),
      mainImage: Image.asset(
  ...
  new PageViewModel(
      ...
      bubbleBackgroundColor: Colors.black,
      title: Text(
        'Insured Retirement Strategy',style: _fontHeaderStyle,
      ),
      body: Text(
          'The Insured Retirement Strategy from ivari allows clients to use the accumulated value in their universal life policy to provide a tax-deferred cash flow of income during their retirement.',textAlign: TextAlign.center,
          style: _fontDescriptionStyle
      ),
      mainImage: Image.asset(
